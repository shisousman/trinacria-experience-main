import { Globe, User, Instagram, Facebook, MessageCircle, ChevronDown, type LucideIcon } from "lucide-react";
...
/**
 * Unified User-Menu Hub: a single top-right glass button that opens a
 * frosted dropdown containing language selection (EN/IT/FR/DE),
 * a "Log In" button, and quick-share platforms.
 */
        ...
        <span className="flex items-center gap-1.5">
          <User
            className={`h-5 w-5 transition-colors ${
              open ? "text-[var(--lemon)]" : "text-[var(--navy-deep)]"
            }`}
            strokeWidth={1.75}
          />
